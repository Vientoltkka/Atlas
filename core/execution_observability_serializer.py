...
class ExecutionObservabilitySerializer:
    ...
    def metrics_to_dict(
        ...
        return {
            ...
            "loops_started": metrics.loops_started,
            "loops_completed": metrics.loops_completed,
            ...
            "retries_started": metrics.retries_started,
            "retry_attempts": metrics.retry_attempts,
            "retry_successes": metrics.retry_successes,
            "retry_failures": metrics.retry_failures,
            "retry_abortions": metrics.retry_abortions,
            "replanning_requests": metrics.replanning_requests,
            "replanning_started": metrics.replanning_started,
            "replanning_succeeded": metrics.replanning_succeeded,
            "replanning_failed": metrics.replanning_failed,
            "replanning_skipped": metrics.replanning_skipped,
            "replanning_limit_reached": metrics.replanning_limit_reached,
            "replanned_plans_executed": metrics.replanned_plans_executed,
            "replanned_goals_satisfied": metrics.replanned_goals_satisfied,
            "replanned_goals_unsatisfied": metrics.replanned_goals_unsatisfied,
            "goal_driven_executions_started": metrics.goal_driven_executions_started,
            "goal_driven_executions_completed": metrics.goal_driven_executions_completed,
            "goal_driven_executions_failed": metrics.goal_driven_executions_failed,
            "goal_driven_cycles_completed": metrics.goal_driven_cycles_completed,
            "goal_driven_goals_satisfied": metrics.goal_driven_goals_satisfied,
            "goal_driven_goals_unsatisfied": metrics.goal_driven_goals_unsatisfied,
            "goal_driven_replans_requested": metrics.goal_driven_replans_requested,
            "goal_driven_replans_succeeded": metrics.goal_driven_replans_succeeded,
            "goal_driven_cycle_limits_reached": metrics.goal_driven_cycle_limits_reached,
