...
class Planner:
    ...
    _INTENT_DESCRIPTIONS = {
        ...
        "calendar.events.list": "List requested calendar events.",
        "calendar.events.create": "Create requested calendar event.",
        "gmail.messages.list": "List recent Gmail messages.",
        "gmail.messages.read": "Read requested Gmail message.",
        "gmail.messages.send": "Send requested email.",
    ...
    _OUTPUT_DESCRIPTIONS = {
        ...
        "calendar_list_events": "Normalized calendar events.",
        "calendar_create_event": "Human-readable created event confirmation.",
        "gmail_list": "Recent Gmail message summaries.",
        "gmail_read": "One Gmail message with body preview.",
        "gmail_send": "Sent recipient and subject.",
